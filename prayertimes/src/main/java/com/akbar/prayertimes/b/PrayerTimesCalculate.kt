...
class PrayerTimesCalculate(private var location: LocationPT?, private var method: Methods?) {
     ...
     */
    fun setLocation(loc: LocationPT) {
        this.location = loc
    }
    ...
    private fun getPrayerTimesByDay(method: Methods?, dc: DayCouple, pt: AzanTimes,
        ...
        val lat: Double = location!!.degreeLat
        val lon: Double = location!!.degreeLong
        invalid = 0
    ...
    private fun base6hm(bs1: Double, method: Methods, pt: Time, type: PrayerTime) {
        var bs = bs1
        var min: Double
        var sec: Double
    ...
    companion object {
        ...
        internal fun getShoMag(loc: LocationPT, astro: Astro, type: PrayerTime): Double {
            ...
            var M: Double = (astro.ra[1] - loc.degreeLong - astro.sid[1]) / 360.0
        ...
        internal fun getThuhr(lon: Double, astro: Astro): Double {
            ...
            var M: Double = (astro.ra[1] - lon - astro.sid[1]) / 360.0
            M = AstrologyFormulas.limitAngle111(M)
        ...
        internal fun getAssr(Lat: Double, dec: Double, madhhab: Madzhab?): Double {
            var part1: Double
            val part2: Double
            val part3: Double
            val part4: Double
        ...
        private fun getDayofYear(year: Int, month: Int, day1: Int): Int {
            var day = day1
        ...
        internal fun getDayInfo(date: SimpleDate, gmt: Double): DayCouple {
            val ld: Int = getDayofYear(date.year, 12, 31)
            val jd: Double = AstrologyFormulas.getJulianDay(date, gmt)
