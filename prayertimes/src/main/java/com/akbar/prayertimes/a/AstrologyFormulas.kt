...
object AstrologyFormulas {
    ...
    private val R3 = arrayOf(doubleArrayOf(145.0, 4.273, 6283.076), doubleArrayOf(7.0, 3.92, 12566.15))

    private val R4 = doubleArrayOf(4.0, 2.56, 6283.08)

    private val PE = arrayOf(doubleArrayOf(-171996.0, -174.2, 92025.0, 8.9), doubleArrayOf(-13187.0, -1.6, 5736.0, -3.1), doubleArrayOf(-2274.0, -0.2, 977.0, -0.5), doubleArrayOf(2062.0, 0.2, -895.0, 0.5), doubleArrayOf(1426.0, -3.4, 54.0, -0.1), doubleArrayOf(712.0, 0.1, -7.0, 0.0), doubleArrayOf(-517.0, 1.2, 224.0, -0.6), doubleArrayOf(-386.0, -0.4, 200.0, 0.0), doubleArrayOf(-301.0, 0.0, 129.0, -0.1), doubleArrayOf(217.0, -0.5, -95.0, 0.3), doubleArrayOf(-158.0, 0.0, 0.0, 0.0), doubleArrayOf(129.0, 0.1, -70.0, 0.0), doubleArrayOf(123.0, 0.0, -53.0, 0.0), doubleArrayOf(63.0, 0.0, 0.0, 0.0), doubleArrayOf(63.0, 0.1, -33.0, 0.0), doubleArrayOf(-59.0, 0.0, 26.0, 0.0), doubleArrayOf(-58.0, -0.1, 32.0, 0.0), doubleArrayOf(-51.0, 0.0, 27.0, 0.0), doubleArrayOf(48.0, 0.0, 0.0, 0.0), doubleArrayOf(46.0, 0.0, -24.0, 0.0), doubleArrayOf(-38.0, 0.0, 16.0, 0.0), doubleArrayOf(-31.0, 0.0, 13.0, 0.0), doubleArrayOf(29.0, 0.0, 0.0, 0.0), doubleArrayOf(29.0, 0.0, -12.0, 0.0), doubleArrayOf(26.0, 0.0, 0.0, 0.0), doubleArrayOf(-22.0, 0.0, 0.0, 0.0), doubleArrayOf(21.0, 0.0, -10.0, 0.0), doubleArrayOf(17.0, -0.1, 0.0, 0.0), doubleArrayOf(16.0, 0.0, -8.0, 0.0), doubleArrayOf(-16.0, 0.1, 7.0, 0.0), doubleArrayOf(-15.0, 0.0, 9.0, 0.0), doubleArrayOf(-13.0, 0.0, 7.0, 0.0), doubleArrayOf(-12.0, 0.0, 6.0, 0.0), doubleArrayOf(11.0, 0.0, 0.0, 0.0), doubleArrayOf(-10.0, 0.0, 5.0, 0.0), doubleArrayOf(-8.0, 0.0, 3.0, 0.0), doubleArrayOf(7.0, 0.0, -3.0, 0.0), doubleArrayOf(-7.0, 0.0, 0.0, 0.0), doubleArrayOf(-7.0, 0.0, 3.0, 0.0), doubleArrayOf(-7.0, 0.0, 3.0, 0.0), doubleArrayOf(6.0, 0.0, 0.0, 0.0), doubleArrayOf(6.0, 0.0, -3.0, 0.0), doubleArrayOf(6.0, 0.0, -3.0, 0.0), doubleArrayOf(-6.0, 0.0, 3.0, 0.0), doubleArrayOf(-6.0, 0.0, 3.0, 0.0), doubleArrayOf(5.0, 0.0, 0.0, 0.0), doubleArrayOf(-5.0, 0.0, 3.0, 0.0), doubleArrayOf(-5.0, 0.0, 3.0, 0.0), doubleArrayOf(-5.0, 0.0, 3.0, 0.0), doubleArrayOf(4.0, 0.0, 0.0, 0.0), doubleArrayOf(4.0, 0.0, 0.0, 0.0), doubleArrayOf(4.0, 0.0, 0.0, 0.0), doubleArrayOf(-4.0, 0.0, 0.0, 0.0), doubleArrayOf(-4.0, 0.0, 0.0, 0.0), doubleArrayOf(-4.0, 0.0, 0.0, 0.0), doubleArrayOf(3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0), doubleArrayOf(-3.0, 0.0, 0.0, 0.0))

    private val SINCOEFF = arrayOf(intArrayOf(0, 0, 0, 0, 1), intArrayOf(-2, 0, 0, 2, 2), intArrayOf(0, 0, 0, 2, 2), intArrayOf(0, 0, 0, 0, 2), intArrayOf(0, 1, 0, 0, 0), intArrayOf(0, 0, 1, 0, 0), intArrayOf(-2, 1, 0, 2, 2), intArrayOf(0, 0, 0, 2, 1), intArrayOf(0, 0, 1, 2, 2), intArrayOf(-2, -1, 0, 2, 2), intArrayOf(-2, 0, 1, 0, 0), intArrayOf(-2, 0, 0, 2, 1), intArrayOf(0, 0, -1, 2, 2), intArrayOf(2, 0, 0, 0, 0), intArrayOf(0, 0, 1, 0, 1), intArrayOf(2, 0, -1, 2, 2), intArrayOf(0, 0, -1, 0, 1), intArrayOf(0, 0, 1, 2, 1), intArrayOf(-2, 0, 2, 0, 0), intArrayOf(0, 0, -2, 2, 1), intArrayOf(2, 0, 0, 2, 2), intArrayOf(0, 0, 2, 2, 2), intArrayOf(0, 0, 2, 0, 0), intArrayOf(-2, 0, 1, 2, 2), intArrayOf(0, 0, 0, 2, 0), intArrayOf(-2, 0, 0, 2, 0), intArrayOf(0, 0, -1, 2, 1), intArrayOf(0, 2, 0, 0, 0), intArrayOf(2, 0, -1, 0, 1), intArrayOf(-2, 2, 0, 2, 2), intArrayOf(0, 1, 0, 0, 1), intArrayOf(-2, 0, 1, 0, 1), intArrayOf(0, -1, 0, 0, 1), intArrayOf(0, 0, 2, -2, 0), intArrayOf(2, 0, -1, 2, 1), intArrayOf(2, 0, 1, 2, 2), intArrayOf(0, 1, 0, 2, 2), intArrayOf(-2, 1, 1, 0, 0), intArrayOf(0, -1, 0, 2, 2), intArrayOf(2, 0, 0, 2, 1), intArrayOf(2, 0, 1, 0, 0), intArrayOf(-2, 0, 2, 2, 2), intArrayOf(-2, 0, 1, 2, 1), intArrayOf(2, 0, -2, 0, 1), intArrayOf(2, 0, 0, 0, 1), intArrayOf(0, -1, 1, 0, 0), intArrayOf(-2, -1, 0, 2, 1), intArrayOf(-2, 0, 0, 0, 1), intArrayOf(0, 0, 2, 2, 1), intArrayOf(-2, 0, 2, 0, 1), intArrayOf(-2, 1, 0, 2, 1), intArrayOf(0, 0, 1, -2, 0), intArrayOf(-1, 0, 1, 0, 0), intArrayOf(-2, 1, 0, 0, 0), intArrayOf(1, 0, 0, 0, 0), intArrayOf(0, 0, 1, 2, 0), intArrayOf(0, 0, -2, 2, 2), intArrayOf(-1, -1, 1, 0, 0), intArrayOf(0, 1, 1, 0, 0), intArrayOf(0, -1, 1, 2, 2), intArrayOf(2, -1, -1, 2, 2), intArrayOf(0, 0, 3, 2, 2), intArrayOf(2, -1, 0, 2, 2))

    fun getRefraction(loc: LocationPT, sunAlt: Double): Double {

        val part1: Double = loc.pressure / 1010.0 * (283 / (273 + loc.temperature))
        val part2: Double = 1.02 / (Utils.RAD_TO_DEG(tan(Utils.DEG_TO_RAD(sunAlt + 10.3 / (sunAlt + 5.11)))) + 0.0019279)
    ...
    fun getJulianDay(date: SimpleDate, gmt: Double): Double {
        ...
        var jdY: Double = date.year.toDouble()
        var jdM: Double = date.month.toDouble()
    ...
    fun getAstroValuesByDay(julianDay: Double,
                            loc: LocationPT, astro: Astro, topAstro: Astro) {
        val ad = AstrologyDay()

        when {
            astro.jd == julianDay - 1 -> {
    ...
    private fun computeAstroDay(JD: Double, astroday: AstrologyDay) {
        ...
        tL = (L0sum + L1sum * JM + L2sum * JM2 + L3sum * JM3
                + L4sum * JM4 + L5sum * JM5) / 10.0.pow(8.0)
        ...
        tB = (B0sum + B1sum * JM) / 10.0.pow(8.0)
        ...
        R = (R0sum + R1sum * JM + R2sum * JM2 + R3sum * JM3 + R4sum * JM4) / 10.0.pow(8.0)

        G = limitAngle(L + 180)
        Gg = -B

        X0 = 297.85036 + 445267.111480 * JC - 0.0019142 * JC.pow(2.0) + JC.pow(3.0) / 189474.0
        X1 = (357.52772 + 35999.050340 * JC - 0.0001603 * JC.pow(2.0)
                - JC.pow(3.0) / 300000.0)
        X2 = (134.96298 + 477198.867398 * JC + 0.0086972 * JC.pow(2.0)
                + JC.pow(3.0) / 56250.0)
        X3 = 93.27191 + 483202.017538 * JC - 0.0036825 * JC.pow(2.0) + JC.pow(3.0) / 327270.0
        X4 = (125.04452 - 1934.136261 * JC + 0.0020708 * JC.pow(2.0)
                + JC.pow(3.0) / 450000.0)
        ...
        U = JM / 10.0
        E0 = 84381.448 - 4680.93 * U - 1.55 * U.pow(2.0) + 1999.25 * U.pow(3.0) - 51.38 * U.pow(4.0) - 249.67 * U.pow(
            5.0
        ) - 39.05 * U.pow(6.0) + 7.12 * U.pow(7.0) + 27.87 * U.pow(8.0) + 5.79 * U.pow(
            9.0
        ) + 2.45 * U.pow(10.0)
        E = E0 / 3600.0 + deltaEps
        lamda = G + deltaPsi + -20.4898 / (3600.0 * R)

        V0 = 280.46061837 + 360.98564736629 * (JD - 2451545) + 0.000387933 * JC.pow(2.0) - JC.pow(
            3.0
        ) / 38710000.0
    ...
    fun computeTopAstro(loc: LocationPT, astro: Astro,
                        topAstro: Astro) {
        var lHour: Double
        var SP: Double
        var tU: Double
